...
_.toReadonlyArray({ a: 1 }) // $ExpectType readonly (readonly ["a", number])[]
_.toReadonlyArray(l1) // $ExpectType readonly (readonly ["a", number])[]
_.toReadonlyArray(d1) // $ExpectType readonly (readonly [string, number])[]
_.toReadonlyArray(r1) // $ExpectType readonly (readonly ["a" | "b", number])[]
...
_.traverseWithIndex(O.applicativeOption)((_k, n: number) => O.some(n))(d1) // $ExpectType Option<Readonly<Record<string, number>>>
_.traverseWithIndex(O.applicativeOption)((_k: 'a' | 'b', n: number) => O.some(n))(r1) // $ExpectType Option<Readonly<Record<"a" | "b", number>>>

_.traverse(O.applicativeOption)((n: number) => O.some(n))(d1) // $ExpectType Option<Readonly<Record<string, number>>>
_.traverse(O.applicativeOption)((n: number) => O.some(n))(r1) // $ExpectType Option<Readonly<Record<"a" | "b", number>>>

_.sequence(O.applicativeOption)(do1) // $ExpectType Option<Readonly<Record<string, number>>>
_.sequence(O.applicativeOption)(ro1) // $ExpectType Option<Readonly<Record<"a" | "b", number>>>

_.compact(do1) // $ExpectType Readonly<Record<string, number>>
...
_.fromFoldable(getFirstSemigroup<number>(), RA.foldableReadonlyArray)(arr1) // $ExpectType Readonly<Record<string, number>>
_.fromFoldable(getFirstSemigroup<number>(), RA.foldableReadonlyArray)(arr2) // $ExpectType Readonly<Record<"a" | "b", number>>
...
_.toUnfoldable(RA.unfoldableReadonlyArray)({ a: 1 }) // $ExpectType readonly (readonly ["a", number])[]
_.toUnfoldable(RA.unfoldableReadonlyArray)({ a: 1, b: 2 }) // $ExpectType readonly (readonly ["a" | "b", number])[]
